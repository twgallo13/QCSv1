...
1) **Repo Skeleton (verify and complete)**
...
- Stage all, commit with a clear message, and push `main`:
    - `chore(repo): bootstrap structure, scripts, and ci (QCSv1.ops.v1.0.0)`

## Completed

```

if you want, i can also generate the matching `cursor_prompts.md` and `smithers_prompts.md` seed files next, plus the ready-to-paste contents for `context/lisa_boot.md` and the three backfilled log files.
